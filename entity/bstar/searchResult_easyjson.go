...
func easyjson6fde4177DecodeGithubComJasonKhew96BiliroamingGoServerEntityBstar(in *jlexer.Lexer, out *SearchResult) {
...
func easyjson6fde4177EncodeGithubComJasonKhew96BiliroamingGoServerEntityBstar(out *jwriter.Writer, in SearchResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v SearchResult) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6fde4177EncodeGithubComJasonKhew96BiliroamingGoServerEntityBstar(&w, v)
...
func (v *SearchResult) UnmarshalJSON(data []byte) error {
	...
	easyjson6fde4177DecodeGithubComJasonKhew96BiliroamingGoServerEntityBstar(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SearchResult) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6fde4177DecodeGithubComJasonKhew96BiliroamingGoServerEntityBstar(l, v)
}

-- +migrate Up
DROP TABLE IF EXIST th_season_episode_caches;
DROP TABLE IF EXIST th_season_caches;
DROP TABLE IF EXIST th_season2_episode_caches;
DROP TABLE IF EXIST th_season2_caches;

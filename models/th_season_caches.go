...
func (o *THSeasonCach) SeasonTHSeasonEpisodeCaches(mods ...qm.QueryMod) thSeasonEpisodeCachQuery {
	...
	query := THSeasonEpisodeCaches(queryMods...)
	queries.SetFrom(query.Query, "\"th_season_episode_caches\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"th_season_episode_caches\".*"})
	}
...
func THSeasonCaches(mods ...qm.QueryMod) thSeasonCachQuery {
	...
	return thSeasonCachQuery{NewQuery(mods...)}
}

...
func (o *THSeason2Cach) SeasonTHSeason2EpisodeCaches(mods ...qm.QueryMod) thSeason2EpisodeCachQuery {
	...
	query := THSeason2EpisodeCaches(queryMods...)
	queries.SetFrom(query.Query, "\"th_season2_episode_caches\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"th_season2_episode_caches\".*"})
	}
...
func THSeason2Caches(mods ...qm.QueryMod) thSeason2CachQuery {
	...
	return thSeason2CachQuery{NewQuery(mods...)}
}

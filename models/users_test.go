...
var (
	userDBTypes = map[string]string{`UID`: `bigint`, `Name`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `VipDueDate`: `timestamp without time zone`}
	_           = bytes.MinRead
)
